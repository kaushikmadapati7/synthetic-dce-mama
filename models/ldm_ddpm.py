"""2D Latent Diffusion Model with a DDPM backbone.

Operates in the latent space of `AutoencoderKL2D`. The U-Net is trained to
...
2D translation of the 3D pipeline's models/ldm_ddpm.py: the diffusion logic is
